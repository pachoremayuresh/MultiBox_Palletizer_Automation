...
#ifndef _BUR_1728629492_1_
#define _BUR_1728629492_1_
...
_GLOBAL float Conv_Pos;
_GLOBAL float Blade_Pos;
_GLOBAL float Cut_depth;
_GLOBAL float Cutter_Speed;
_GLOBAL float Cut_Pos;
...
_GLOBAL float S_Actual_Velocity;
_GLOBAL float S_Actual_Position;
_GLOBAL plcbit S_Active;
_GLOBAL struct FSM_AXIS Slave;
_GLOBAL plcbit Done_Cut;
_GLOBAL plcbit Do_Cut;
_GLOBAL plcbit M_Stoped;
_GLOBAL plcbit M_Powered;
_GLOBAL plcbit M_Homed;
_GLOBAL float M_Actual_Velocity;
_GLOBAL float M_Actual_Position;
_GLOBAL plcbit M_Active;
_GLOBAL struct FSM_AXIS Master;
...
_GLOBAL float Conv_Man_HMI;
_GLOBAL float Blade_Man_HMI;
