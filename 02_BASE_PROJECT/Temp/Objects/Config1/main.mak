...
export AS_PROJECT_PATH := D:/Pachore_Mayuresh_ASDP/Pachore_Mayuresh_Project_2/Pachore_Mayuresh_Project_2
export AS_PROJECT_NAME := Pachore_Mayuresh_Project_2
export AS_SYSTEM_PATH := C:/Program\ Files/BRAutomation4/AS/System
export AS_VC_PATH := C:/Program\ Files/BRAutomation4/AS412/AS/VC
export AS_TEMP_PATH := D:/Pachore_Mayuresh_ASDP/Pachore_Mayuresh_Project_2/Pachore_Mayuresh_Project_2/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := D:/Pachore_Mayuresh_ASDP/Pachore_Mayuresh_Project_2/Pachore_Mayuresh_Project_2/Binaries
...
export WIN32_AS_PROJECT_PATH := "D:\Pachore_Mayuresh_ASDP\Pachore_Mayuresh_Project_2\Pachore_Mayuresh_Project_2"
...
export WIN32_AS_TEMP_PATH := "D:\Pachore_Mayuresh_ASDP\Pachore_Mayuresh_Project_2\Pachore_Mayuresh_Project_2\Temp"
export WIN32_AS_BINARIES_PATH := "D:\Pachore_Mayuresh_ASDP\Pachore_Mayuresh_Project_2\Pachore_Mayuresh_Project_2\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Pachore_Mayuresh_Project_2.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'   
